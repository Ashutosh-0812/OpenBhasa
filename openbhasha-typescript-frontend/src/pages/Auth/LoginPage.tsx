...
const AuthLayout: React.FC<{ title: string; children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#F7FAF8' }}>
      {children}
    </Box>
  );
};
    ...
    <AuthLayout title="Sign in">
      <Container
        ...
        sx={{
          ...
          py: { xs: 1, sm: 2 },
          width: '100%',
          backgroundColor: '#F7FAF8', // Off-White Background
        }}
      >
        <Paper
          elevation={0}
          sx={{
            ...
            background: '#E8F3EC', // Light Green Card Background
            border: '1px solid',
            borderColor: '#107C10', // Dark Green Border
            boxShadow: {
              xs: '0 4px 16px rgba(16, 124, 16, 0.15)',
              sm: '0 8px 32px rgba(16, 124, 16, 0.2)',
            },
          }}
        >
          {/* Header */}
          <Box textAlign="center" mb={{ xs: 3, sm: 4 }}>
            <Box
              sx={{
                ...
                height: { xs: 64, sm: 72 },
                borderRadius: '50%',
                background: '#107C10', // Dark Green Logo Circle
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                mx: 'auto',
                mb: { xs: 2, sm: 3 },
                boxShadow: '0 8px 24px rgba(16, 124, 16, 0.4)',
              }}
            >
              <AccountCircle
                sx={{
            ...
            <Typography
              ...
              sx={{
                ...
                fontWeight: 600,
                color: '#145C2E', // Medium Green for Headings
                mb: 1,
              }}
            >
              Welcome Back
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    color: '#0C7A00', // Darker Green on Hover
                  },
                }}
              >
                Forgot password?
            ...
            <Button
              ...
              sx={{
                ...
                background: isLoading
                  ? 'rgba(16, 124, 16, 0.6)'
                  : '#107C10', // Dark Green Button
                boxShadow: isLoading
                  ? 'none'
                  : '0 6px 20px rgba(16, 124, 16, 0.4)',
                minHeight: { xs: 48, sm: 'auto' },
                '&:hover': {
                  background: isLoading
                    ? 'rgba(16, 124, 16, 0.6)'
                    : '#0C7A00', // Darker Green on Hover
                  boxShadow: '0 8px 25px rgba(16, 124, 16, 0.5)',
                },
              }}
            >
              {/* Use isLoading from useAuth */}
          ...
          <Box
            ...
            p={{ xs: 2, sm: 3 }}
            sx={{
              background: '#F7FAF8', // Off-White Background
